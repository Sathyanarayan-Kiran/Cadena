...
- Limits: classification is not role-gated; a synced state that no workflow declares terminal stays unclassified after the item is done; cost of delay is US21.4.
