...
- Limits: classification is not role-gated; a synced state that no workflow declares terminal stays unclassified after the item is done; wait reasons, risk and cost of delay are US21.2 to US21.4.
