...
- Limits: classification is not role-gated; a synced state that no workflow declares terminal stays unclassified after the item is done; risk of waiting and cost of delay are US21.3 and US21.4.
